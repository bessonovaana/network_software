...
if _version_not_supported:
    raise RuntimeError(
        ...
        + " Please upgrade your grpc module to grpcio>={GRPC_GENERATED_VERSION}"
...
class NotificationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendNotification = channel.unary_unary(
            ...
            response_deserializer=notification__pb2.SendResponse.FromString,
...
def add_NotificationServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
        "SendNotification": grpc.unary_unary_rpc_method_handler(
            ...
            response_serializer=notification__pb2.SendResponse.SerializeToString,
        ),
    }
...
class NotificationService(object):
    ...
    def SendNotification(
        ...
        return grpc.experimental.unary_unary(
            ...
            notification__pb2.SendResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
